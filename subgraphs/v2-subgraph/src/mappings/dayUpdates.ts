...
import { Bundle, Pair, PairDayData, Token, TokenDayData, KalyswapDayData, KalyswapFactory } from '../types/schema'
...
export function updateKalyswapDayData(event: ethereum.Event): KalyswapDayData {
  ...
  if (kalyswapDayData === null) {
    ...
    kalyswapDayData.dailyVolumeKLC = ZERO_BD
    kalyswapDayData.totalVolumeUSD = ZERO_BD
    kalyswapDayData.totalVolumeKLC = ZERO_BD
...
export function updateTokenDayData(token: Token, event: ethereum.Event): TokenDayData {
  ...
  if (tokenDayData === null) {
    ...
    tokenDayData.dailyVolumeKLC = ZERO_BD
